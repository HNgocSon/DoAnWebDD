    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
          <li><a class="dropdown-item" style="font-size: x-small;" href="#"><strong>Quản lý tài khoản khách hàng</strong></a></li>
          <li><a class="dropdown-item" style="font-size: x-small;" href="#"><strong>Quản lý tài khoản admin</strong></a></li>
        </ul>
      </li>
