...
<div class="table-responsive">
    ...
    <p>Tổng Số Hóa Đơn: {{ $tongHoaDon }}</p>
    <p>Tổng doanh thu: {{ $tongTien }}</p>
    <p>Tổng doanh thu Thực Tế: {{ $tongTienThucTe }}</p>

    <form action="{{ route('thong-ke.doanh-so-ban-hang') }}" method="get">
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    {
                        label: 'Tổng Tiền Bán Hàng Thực Tế',
                        data: [{{ $tongTienThucTe }}],
